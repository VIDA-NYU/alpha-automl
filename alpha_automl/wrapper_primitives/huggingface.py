...
class HuggingfaceInterface(BaseEstimator, TransformerMixin):
    ...
    def transform(self, texts):
        ...
        for start in range(0, total_length, batch_size):
            ...
            with torch.no_grad():
                out = self.model(**ids)  #model output contains last_hidden_state, pooler_output, hidden_outputs of each model layer and the embedding layer
...
class HuggingfaceInterface(BaseEstimator, TransformerMixin):
    ...
    def transform(self, texts):
        ...
        return batch_embeddings
>>>>>>> 0cd4f3116210bd8adfa3fad4420263ce1e238418
